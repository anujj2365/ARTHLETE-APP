      ...
      <View style={styles.gradientContainer}>
        ...
        <View style={styles.quoteContainer}>
          <Text style={styles.quoteText}>
            YOUR <Text style={styles.highlightText}>DIET</Text>{'\n'}
            YOUR <Text style={styles.highlightText}>RESULTS</Text>
          </Text>
        </View>

        {/* Custom Diet Plans Text - Now outside quote container */}
        <Text style={styles.customPlanText}>
          Customized <Text style={styles.blackText}>diet</Text> plans to fuel{'\n'}
          your body and achieve your{'\n'}
          <Text style={styles.blackText}>fitness</Text> goals
        </Text>
